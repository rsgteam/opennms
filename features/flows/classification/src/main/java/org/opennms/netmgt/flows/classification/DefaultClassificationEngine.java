...
public class DefaultClassificationEngine implements ClassificationEngine {
    ...
    // TODO MVR can probably be removed when a real DAO implementation exists
    ...
    public void reload() {
        ...
        // TODO MVR rework order (should be set in ui instead)
        Collections.sort(classifierList, (left, right) -> Integer.compare(left.getPriority(), right.getPriority()) * -1);
    }
    ...
    public String classify(ClassificationRequest classificationRequest) {
        ...
        // what an unmapped definition should be mapped to.

...
public class ClassificationRequest {
    ...
    public ClassificationRequest(int port, String ipAddress, ProtocolType protocol) {
        this.port = port;
    ...
    public boolean equals(Object o) {
        ...
        boolean equals = Objects.equals(port, that.port)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(port, protocol, ipAddress);
    }
}
